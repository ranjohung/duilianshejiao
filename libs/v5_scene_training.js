...
(function (global) {
  ...
  const SceneTraining = {
    ...
    _container: null,    saveChallenge: function () {
      ...
      const item = { levelId: level.id || 9001, scene: level.title || '礼仪场景', challenge: '把本课的一个动作和一句话带到真实场景', note: text, feeling: feeling ? feeling.value : '', dialogueTurns: Object.keys(SceneTraining._dialogueAnswers || {}).length, dialogue: SceneTraining._dialogueAnswers || {}, recommendation: recommendation, createdAt: Date.now() };
